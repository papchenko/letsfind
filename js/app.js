(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const acceptButtons = [ document.querySelector(".submit-two"), document.querySelector(".submit-three"), document.querySelector(".submit-final") ];
        const inputFields = [ document.querySelector(".input_field-two"), document.querySelector(".input_field-three"), document.querySelector(".input_field-final") ];
        const hiddenTexts = [ document.querySelector(".quest-two"), document.querySelector(".quest-three"), document.querySelector(".quest-final") ];
        ...
        const sets = acceptButtons.map(((button, index) => ({
            ...
            hiddenText: hiddenTexts[index],
            hiddenForms: hiddenForms[index],
        ...
        async function loadPopupContent() {
            try {
                ...
                if (response.ok) {
                    ...
                    const correctMessageElement = doc.querySelector(".correct__message");
                    const wrongMessageElement = doc.querySelector(".wrong__message");
                    return {
                        correctMessageContent: correctMessageElement ? correctMessageElement.outerHTML : "",
                        wrongMessageContent: wrongMessageElement ? wrongMessageElement.outerHTML : ""
                    };
                } else return {
        ...
        async function handleButtonClick(set) {
            ...
            const popupContent = await loadPopupContent();
            function handleVisibility() {
                ...
                setTimeout((() => {
                    popupAlertWrapper.style.display = "none";
                    document.querySelector(".popup-show")?.classList.remove("popup-show");
                    popupAlertWrapper.classList.remove(".popup-show");
                    document.querySelector(".lock")?.classList.remove("lock");
                }), 1e4);
            }
            acceptButton.addEventListener("click", handleVisibility);
            inputField.addEventListener("keyup", (function(event) {
                if (event.key === "Enter") handleVisibility();
            }));
